    ...
    <Modal open={open} onClose={onClose} title="Add Lead">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            name="query"
            className="min-h-[80px] w-full resize-none rounded-[--radius-md] border border-[--color-border] bg-[--color-surface-2] px-3.5 py-2.5 text-sm text-[--color-text-primary] placeholder:text-[--color-text-muted] transition-all duration-100 focus:border-[--color-gold] focus:outline-none focus:ring-2 focus:ring-[--color-gold-dim]"
